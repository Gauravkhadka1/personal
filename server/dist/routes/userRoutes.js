...
router.put("/role/:userId", authMiddleware_1.authenticateToken, userController_1.updateUserRole);
...
router.get("/:userId/activities", authMiddleware_1.authenticateToken, userController_1.getUserActivityLogs);
router.get("/:userId/comments", userController_1.getUserComments);
router.patch('/presence', authMiddleware_1.authenticateToken, userController_1.updateLastSeen);
